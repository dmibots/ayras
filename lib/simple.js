...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Support Me!', body: `Click Here!`, sourceUrl: 'https://api-kaysa.herokuapp.com', thumbnail: data }}, options })
    }
